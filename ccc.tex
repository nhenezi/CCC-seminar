...
\begin{document}
  ...
  primjera.
  Intuitivno, teorija kategorije proucava "objekte" i preslikavanje izmedu objekata.
  \begin{definition}
  ...
  \begin{primjer}
    ...
    a strelica ne mora biti uobicajena funkcija.
  ...
  \begin{primjer}
    ...
    asocijativnosti i identiteta, tj. da tako zadana struktura stvarno je
    kategorija.
